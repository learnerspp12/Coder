...
def main():
    ...
    tk.Button(frame, text="Exit Fullscreen", command=exit_fullscreen).pack(pady=5)

    #  Optional: Add an Exit/Close App button
    tk.Button(frame, text="Exit App", command=root.destroy).pack(pady=5)
